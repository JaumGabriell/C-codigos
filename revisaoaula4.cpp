...
int main()
{
	int custo[100][100]; // 100 -> numero maximo de dia 

    int custoPorDia; // custo de manter o circo na cidade

	int n; // numero de dias
	
	cout << "Entre com o numero de dias que George pode trazer o circo na cidade" << endl;
	cin >> n;
